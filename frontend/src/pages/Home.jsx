...
function Home() {
  ...
  const handleMouseMove = (e) => {
    ...
    const xRotation = ((offsetY / clientHeight) - 0.5) * 30; 
    const yRotation = ((offsetX / clientWidth) - 0.5) * 30;

    containerRef.current.style.transform = `rotateX(${xRotation}deg) rotateY(${yRotation}deg) scale(1.05)`;
  };

  const handleMouseLeave = () => {
    containerRef.current.style.transform = 'rotateX(0deg) rotateY(0deg) scale(1.1)';
  };
  ...
  return (
    <div className="bg-[#f8f9ff] py-24 text-black text-[15px] -mt-8">
      ...
      <div
        ...
        className="mt-28 max-w-4xl mx-auto text-center relative z-10 transition-transform duration-300"
        style={{ perspective: '800px', pointerEvents: 'auto' }}
      >
        <h1 className="md:text-6xl text-4xl font-extrabold mb-6 md:!leading-[75px]">
          Welcome to <span className="text-green-600">theHub</span>!
        </h1>
        <p className="mt-10 text-base">
          <strong>theHub</strong> is your go-to community platform where <strong>innovation, collaboration, and creativity</strong> come together. Share your thoughts, seek advice, and engage with experts and enthusiasts from around the globe.
        </p>

        <p className="mt-6 text-base">
          Dive into diverse topics, submit your questions, and contribute knowledge. At <strong>theHub</strong>, every idea is valued, and every voice matters.
        </p>

        <div className="mt-10">
        <button
            onClick={handleJoinDiscussion}
            className="px-6 py-3 mt-8 rounded-xl text-white bg-green-600 transition-all hover:bg-green-900"
          >
            Join the Discussion
          </button>
        </div>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 py-2 font-extrabold  bg-green-600 text-white rounded-full p-4 shadow-lg hover:bg-green-900 transition-all"
      >
        ↓
      </button>
      ...
      <div className="mt-28 bg-gray-50 px-4 sm:px-10 py-12">
        <div className="max-w-7xl mx-auto">
          <h2 className="md:text-4xl text-3xl font-bold md:text-center mb-14">Our Latest Topics</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-14">
            {/* Blog Post 1 */}
            <div className="bg-transparent cursor-pointer rounded-md overflow-hidden group">
              <div className="relative overflow-hidden">
                <img
                  src="https://readymadeui.com/Imagination.webp"
                  alt="Blog Post 1"
                  className="w-full h-60 object-cover rounded-full group-hover:scale-125 transition-all duration-300"
                />
                {/* <div className="px-4 py-2.5 text-white bg-green-800 absolute bottom-0 right-0">
                  June 10, 2023
                </div> */}
              </div>
              <div className="p-6">
                <h3 className="text-xl flex justify-center mr-auto ml-auto font-semibold"> Igniting Your Imagination</h3>
                <button type="button" className="bg-green-600 hover:bg-green-900 text-white rounded-2xl mr-auto ml-auto flex  px-5 py-2.5 mt-6 transition-all">
                  Read More
                </button>
              </div>
            </div>
            ...
            <div className="bg-transparent cursor-pointer rounded-md overflow-hidden group">
              ...
              <div className="p-6">
                <h3 className="text-xl flex justify-center mr-auto ml-auto font-semibold">Hacks to Supercharge Your Day</h3>
                <button type="button" className="bg-green-600 hover:bg-green-900 text-white rounded-2xl mr-auto ml-auto flex  px-5 py-2.5 mt-6 transition-all">
                  Read More
                </button>
              </div>
            ...
            <div className="bg-transparent cursor-pointer rounded-md overflow-hidden group">
              ...
              <div className="p-6">
                <h3 className="text-xl flex justify-center mr-auto ml-auto font-semibold">Trends and Predictions</h3>
                <button type="button" className="flex items-center ml-auto mr-auto bg-green-600 hover:bg-green-900 text-white rounded-2xl px-5 py-2.5 mt-6 transition-all">
                  Read More
                </button>
              </div>
            </div>
    ...
    <h2 class="md:text-4xl text-3xl font-extrabold text-black mb-4">Our Forum Features</h2>
    <p class="mt-6 text-gray-600">
        A robust community platform with powerful tools to share, engage, and collaborate. Connect, submit ideas, and interact seamlessly with fellow members.
    </p>
</div>

        <div class="grid lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg mx-auto gap-8">
          <div class="sm:p-6 p-4 flex bg-white rounded-3xl shadow-2xl border ">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
              class="w-12 h-12 mr-6 bg-green-200 p-3 rounded-md shrink-0" viewBox="0 0 32 32">
              <path
          ...
          <div class="sm:p-6 p-4 flex bg-white rounded-3xl shadow-2xl border">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
              class="w-12 h-12 mr-6 bg-green-200 p-3 rounded-md shrink-0" viewBox="0 0 682.667 682.667">
              <defs>
          ...
          <div class="sm:p-6 p-4 flex bg-white rounded-3xl shadow-2xl border">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
              class="w-12 h-12 mr-6 bg-green-200 p-3 rounded-md shrink-0" viewBox="0 0 512.001 512.001">
              <path
          ...
          <div class="sm:p-6 p-4 flex bg-white rounded-3xl shadow-2xl border">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
              class="w-12 h-12 mr-6 bg-green-200 p-3 rounded-md shrink-0" viewBox="0 0 24 24">
          ...
          <div class="sm:p-6 p-4 flex bg-white rounded-3xl shadow-2xl border">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
              class="w-12 h-12 mr-6 bg-green-200 p-3 rounded-md shrink-0" viewBox="0 0 504.69 504.69">
              <path
